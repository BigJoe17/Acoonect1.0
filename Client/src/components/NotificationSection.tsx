...
const comments: Comment[] = [
  { id: 1, name: 'Alice', text: 'Great post! Really enjoyed it.', time: '10:15 AM' },
  { id: 2, name: 'Bob', text: 'I totally agree with you.', time: '10:20 AM' },
  { id: 3, name: 'Charlie', text: 'Interesting perspective.', time: '10:25 AM' },
  { id: 4, name: 'Diana', text: 'Thanks for sharing this.', time: '10:30 AM' },
  { id: 5, name: 'Eve', text: 'Looking forward to more posts like this.', time: '10:35 AM' },
];
    ...
    <div className="flex flex-col p-6 space-y-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex flex-col gap-4 mb-6">
        <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg shadow-sm">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-gray-600">{likesCount} people liked this post</span>
          </div>
        </div>
        <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg shadow-sm">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-gray-600">{commentsCount} people commented on this post</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col space-y-4">
        {comments.map((comment) => (
          <div key={comment.id} className="flex items-start gap-3 p-4 bg-gray-100 rounded-lg shadow-sm">
            <img
